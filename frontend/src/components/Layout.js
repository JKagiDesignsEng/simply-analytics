...
const Layout = () => {
    ...
    return (
        <div className={`min-h-screen ${themeColors.background} transition-colors duration-200`}>
            ...
            <div
                className={`
        fixed inset-y-0 left-0 z-50 w-64 ${themeColors.card} shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0
        ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}
      `}
            >
                <div className={`flex items-center justify-between h-16 px-6 border-b ${themeColors.border}`}>
                    ...
                    <button
                        onClick={() => setSidebarOpen(false)}
                        className={`lg:hidden ${themeColors.textSecondary} hover:${themeColors.text}`}
                    >
                        <X className='h-6 w-6' />
                    </button>
                </div>
            ...
            <div className='lg:pl-64'>
                {/* Top header */}
                <header className={`${themeColors.card} shadow-sm border-b ${themeColors.border}`}>
